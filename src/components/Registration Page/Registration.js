                    ...
                    <div className="bg-[#f1f1f2] p-8 w-[94%] border-[#9c9b9b] border">
                        <div className="flex gap-6">
                            <div className="bg-white border border-[#ccc] flex rounded-[10px]  pl-[8px] pr-[10px]">
                                <div className="flex justify-center p-[8px] pl-0 items-center w-[35px]"><img className="w-[80%]" src="facebook.png" alt="facebook" /></div>
                                <span className="border-l p-[8px] flex justify-center items-center text-[#58595b] font-[700] text-[14.5px]">Facebook</span>
                            </div>
                             <div className="bg-white  border border-[#ccc] flex rounded-[10px] pl-[8px] pr-[10px]">
                                <div className="flex justify-center p-[8px] pl-0 items-center w-[35px]"><img className="w-[80%]" src="google.png" alt="google"/></div>
                        ...
                        <input className="h-[30px] w-[286px] text-[14px] border border-[#ccc] pl-[15px] p-[18px] rounded-[10px] outline-none" placeholder="Enter Phone Number"/>
