            ...
            <div className="navbar-container bg-white flex h-[70px] justify-between w-[100%] border border-gray-300">
                ...
                <div className="search-container flex items-center w-[40%] justify-center gap-10 pr-5">
                    ...
                    <div className="nav-icons flex w-[26%] justify-between items-center text-gray-600">
                        ...
                        <Link to="/cart"><div className="relative nav-icon items-center"><svg  xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#4b5563"><path d="M223.5-103.5Q200-127 200-160t23.5-56.5Q247-240 280-240t56.5 23.5Q360-193 360-160t-23.5 56.5Q313-80 280-80t-56.5-23.5Zm400 0Q600-127 600-160t23.5-56.5Q647-240 680-240t56.5 23.5Q760-193 760-160t-23.5 56.5Q713-80 680-80t-56.5-23.5ZM246-720l96 200h280l110-200H246Zm-38-80h590q23 0 35 20.5t1 41.5L692-482q-11 20-29.5 31T622-440H324l-44 80h480v80H280q-45 0-68-39.5t-2-78.5l54-98-144-304H40v-80h130l38 80Zm134 280h280-280Z" /></svg></div></Link>
                    </div>
                </div>
